...
try:
    from backend.agent.magazine.graph import app as agent_app
    from backend.agent.magazine.nodes import llm as agent_llm
except Exception:
    try:
        from backend.agent.magazine.graph import workflow
